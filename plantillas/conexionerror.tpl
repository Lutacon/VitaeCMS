...
<div class="container conexioncuerpo">
      ...
      <form class="formularioiniciosesion" action="conexion-segura.php" method="post" name="login_form" role="form">
        ...
        <input name="mail" type="email" class="form-control" placeholder="Correo electrónico" required="" autofocus=""><br>
    ...
    <div class="container"><div class="row"><div class="col-md-12"><div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> Error al introducir los datos del inicio de sesión, <b>inténtalo de nuevo</b></div></div></div></div>
